...
<h1> Εμφάνιση καθηγητή με id: <?php echo $model->id; ?></h1>
...
$this->widget('booster.widgets.TbDetailView', array(
    ...
    'attributes' => array(
        ...
        'user_id',
        'department',
        'user.username','user.password','user.activated','user.first_name','user.lastname',
        'user.email','user.telephone','user.academicid','user.department'
    ),
));
?>
