...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'act_code'); ?>
		<?php echo $form->textField($model,'act_code'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'aem'); ?>
		<?php echo $form->textField($model,'aem'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'academicid'); ?>
		<?php echo $form->textField($model,'academicid',array('size'=>12,'maxlength'=>12)); ?>
	</div>
