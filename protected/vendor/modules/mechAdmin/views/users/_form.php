...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model,'activated'); ?>
	...
	<div class="row">
		<?php //echo $form->labelEx($model,'act_code'); ?>
		<?php echo $form->textFieldGroup($model,'act_code'); ?>
		<?php //echo $form->error($model,'act_code'); ?>
	</div>
