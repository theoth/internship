...
class InternshipPosition extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('company_id, title, description, published,department_id', 'required'),
            array('atlas,department_id,repeated,questionnaire_student_id,questionnaire_professor_id,questionnaire_company_id,company_id, professor_id, student_id, status_submit_student, status_submit_company, status_submit_professor, status, published, year, st_absence1, st_absence2, st_absence3, co_absence1, co_absence2, co_absence3', 'numerical', 'integerOnly' => true),
            array('grade,period', 'numerical'),
            array('date_start', 'date', 'format' => 'yyyy-MM-dd'),
            array('date_end', 'date', 'format' => 'yyyy-MM-dd'),
            array('deadline', 'date', 'format' => 'yyyy-MM-dd'),
            array('r_date_start', 'date', 'format' => 'yyyy-MM-dd'),
            array('r_date_end', 'date', 'format' => 'yyyy-MM-dd'),
            array('title', 'length', 'max' => 100),
            array('atlas,st_text1, st_notes1, st_text2, st_notes2, st_text3, st_notes3, st_final_text, st_final_notes, co_text1, co_notes1, co_text2, co_notes2, co_text3, co_notes3, co_final_text, co_final_notes, prof_final_text', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('atlas,department_id,repeated,r_date_start,r_date_end,questionnaire_student_id,questionnaire_professor_id,questionnaire_company_id,id, date_start, date_end, grade,department, company_id, professor_id, student_id, status_submit_student, status_submit_company, status_submit_professor, status, title, description, published, year, st_absence1, st_text1, st_notes1, st_text2, st_notes2, st_text3, st_notes3, st_absence2, st_absence3, st_final_text, st_final_notes, co_absence1, co_absence2, co_absence3, co_text1, co_notes1, co_text2, co_notes2, co_text3, co_notes3, co_final_text, co_final_notes, prof_final_text', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            ...
            'questionnaireStudent' => array(self::BELONGS_TO, 'questionnaireStudent', 'questionnaire_student_id'),
            'questionnaireProfessor' => array(self::BELONGS_TO, 'questionnaireProfessor', 'questionnaire_professor_id'),
            'questionnaireCompany' => array(self::BELONGS_TO, 'questionnaireCompany', 'questionnaire_company_id'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'student_id' => 'Φοιτητής',
            'questionnaire_student_id' => 'Ερωτηματολόγιο Φοιτητή',
            'questionnaire_professor_id' => 'Ερωτηματολόγιο Καθηγητή',
            'questionnaire_professor_id' => 'Ερωτηματολόγιο Εταιρείας',
            ...
            'repeated' => 'Επαναλαμβανόμενη',
            'r_date_start' => 'Διαθέσιμη από',
            'r_date_end' => 'Διαθέσιμη έως',
            'atlas'=>'Κωδικός θέσης στο σύστημα ΑΤΛΑΣ',
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('atlas', $this->atlas);
        $criteria->compare('department_id', $this->department_id);
        $criteria->compare('repeated', $this->repeated);
        $criteria->compare('r_date_start', $this->r_date_start);
        $criteria->compare('r_date_end', $this->r_date_end);
        $criteria->compare('company_id', $this->company_id);
        $criteria->compare('professor_id', $this->professor_id);
        $criteria->compare('student_id', $this->student_id);
        $criteria->compare('questionnaire_company_id', $this->questionnaire_company_id);
        $criteria->compare('questionnaire_professor_id', $this->questionnaire_professor_id);
        $criteria->compare('questionnaire_student_id', $this->questionnaire_student_id);
    ...
    public function searchFromTo($did,$from,$to){
        ...
        $criteria->addCondition('date_start > "'.$from.'"');
        $criteria->addCondition('date_start < "'.$to.'"');
        ...
        if ($did != NULL) {
            $criteria->compare('department_id', $did, true);
        }
